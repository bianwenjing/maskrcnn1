...
from maskrcnn_benchmark.data.datasets import AbstractDataset, COCODataset, ScanNetDataset
...
def coco_evaluation(
    ...
    if isinstance(dataset, COCODataset) or isinstance(dataset, ScanNetDataset):

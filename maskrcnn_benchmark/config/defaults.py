...
_C.MODEL.ROI_BOX_HEAD.NUM_CLASSES = 608
...
_C.MODEL.ROI_DEPTH_HEAD.PREDICTOR = "MaskRCNNC4Predictor"
...
_C.MODEL.ROI_DEPTH_HEAD.CONV_LAYERS = (256, 256, 256, 256)
# _C.MODEL.ROI_DEPTH_HEAD.CONV_LAYERS = (256, 256, 256, 256, 256, 256, 256, 256)
_C.MODEL.ROI_DEPTH_HEAD.RESOLUTION = 14
_C.MODEL.ROI_DEPTH_HEAD.SHARE_BOX_FEATURE_EXTRACTOR = True
# Whether or not resize and translate masks to the input image.
_C.MODEL.ROI_DEPTH_HEAD.POSTPROCESS_MASKS = False
_C.MODEL.ROI_DEPTH_HEAD.POSTPROCESS_MASKS_THRESHOLD = 0.5
# Dilation
...
_C.MODEL.WHOLE_DEPTH.CONV_LAYERS = (256, 256, 256, 256)
...
_C.MODEL.WHOLE_DEPTH.FEATURE_EXTRACTOR = 'RES'
_C.MODEL.WHOLE_DEPTH.PREDICTOR = 'MaskRCNNC4Predictor'
_C.MODEL.WHOLE_DEPTH.LOSS = "MSE"
##############################################################################

...
dic = torch.load("/home/wenjing/storage/result/result20/model_0950000.pth", map_location=torch.device('cpu'))
model = {'model': dic['model']}
torch.save(model,'/home/wenjing/storage/result/result_/model_0950000_result20.pth')
